...
def _save_data(self, path, plot_xyz):
    data_dir = path + os.sep + str(self.cfg_path).split(r"testCases",1)[1][:-4]
    ...
    if self.cellFraction > 0:
        ...
        pureCellSignal, b = _signal(self,self.cellPositionsT1m, self.cellPositionsT2p, xyz = False , finite=True)
