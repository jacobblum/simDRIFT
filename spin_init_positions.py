...
def _find_spin_locations(initial_spin_positions, fiber_centers, cell_centers, rotation_reference):
    ...
    _find_spin_locations_kernel[128,512](spin_in_fiber_at_index_gpu, spin_in_cell_at_index_gpu, initial_spin_positions_gpu, fiber_centers_gpu, cell_centers_gpu, rotation_reference)
    
    ## Get Position Arrays Back to Free Memory??
    initial_spin_positions, cell_centers, fiber_centers = initial_spin_positions_gpu.copy_to_host(), cell_centers_gpu.copy_to_host(), fiber_centers_gpu.copy_to_host()
    ## Return These
    spin_in_fiber_at_index, spin_in_cell_at_index = spin_in_fiber_at_index_gpu.copy_to_host(), spin_in_cell_at_index_gpu.copy_to_host()
    return spin_in_fiber_at_index, spin_in_cell_at_index
@cuda.jit 
