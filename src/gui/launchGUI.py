...
class SetParameterScreen(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.geometry("588x425")  # Sets window size to 588w x 425h pixels
        ...
        frame_fiberSetup = tk.Frame(main_frame, bg="#D3D3D3", relief="groove", bd=2) 
        ...
        frame_cellSetup = tk.Frame(main_frame, bg="#D3D3D3", relief="groove", bd=2) 
        ...
        frame_scanSetup = tk.Frame(main_frame, bg="#D3D3D3", relief="groove", bd=2) 
        ...
        btn_frame = tk.Frame(main_frame, bg="#D3D3D3", relief="groove", bd=2)  
