...
class dmri_simulation:
    ...
    def _set_params_from_config(self, path_to_configuration_file):
        ...
        self.path_to_save = r"C:\Users\kainen.utt\Documents\Research\MosaicProject\6x6\VersionA\SimOutput"
    ...
    def _signal_from_trajectory_data(self,trajectory_dir):
        ...
        for trajectory_file in trajectory_t1ms:
                ...
                if run_xyz:
                    ...
                    nb.save(dwi, traj_dir + os.sep  + compartment + "Signal.nii")
        ...
        if run_xyz:
            ...
            nb.save(dwiTotal,traj_dir + os.sep + "totalSignal.nii")
...
def main():       
    ...
    configs = glob.glob(r"C:\Users\kainen.utt\Documents\Research\MosaicProject\6x6\VersionA\SimOutput\*\*_ConfigA.ini")
    for cfg in configs:
